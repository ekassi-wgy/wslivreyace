<?php
$title = "Abidjan.net, Une Histoire d'Avenir - Commande"
?>
            ...
            <div class="col-12">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-6 text-center text-sm-start">
                        <h3 class="breadcrumb-title">Commande</h3>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="your-order-wrappwer tablet-mt__60 small-mt__60">
                                <h6 class="mb-20">Votre commande</h6>
                                <div class="your-order-area">

                                    <div class="row">

                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            <img src="https://media-files.abidjan.net/livre/img/pc.jpg" alt="Abidjan-net-book" data-at2x="https://media-files.abidjan.net/livre/img/pc.jpg" width="180" height="186">
                                        </div>
                                ...
                                <div class="payment-method">
                                    <div class="row">
                                        ...
                                        <label class="payment__type col-lg-6 col-md-6 col-sm-6 col-xs-6 mb-20" id="omPay">
                                            <input type="radio" name="mode_paiement" value="wave" onchange="choixModePaiement('wave')">
                                            <img src="https://media-files.abidjan.net/livre/img/Wave-Logo.png" data-at2x="https://media-files.abidjan.net/livre/img/Wave-Logo.png" width="160" height="auto">
                                        </label>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 billing-info-wrap" style="margin-top: 25px;">
                                            ...
                                            <div class="billing-info mb-25" id="alertApaym" style="display: none">
                                                ...
                                                <div class="billing-info mb-25" id="alertApaym" style="">
                                                    ...
                                                    <div style="display: flex; align-items: center;">
                                                        <select class="select-active" id="indicatif" name="indicatif" style="width: 130px; margin-right: 5px;">
                                            ...
                                            <div class="billing-info mb-25" id="alert1" style="display: none;">
                                                ...
                                                <input type="text" class="form-control" onkeyup="verif_nombre(this);" maxlength="10" name="destMsisdn" id="destMsisdn">
                                            </div>
                                            ...
                                            <div class="billing-info mb-25" id="alert2" style="display: none;">
                                                ...
                                                <input type="text" class="form-control" onkeyup="verif_nombre(this);" maxlength="10" name="MSISDN" id="MSISDN">
                                            </div>
                                        </div>
...
<script>
   ...
   ========================================================================== */
    ...
    /************ Set les indicatifs des num de tel pour le paiement APaym **************/
    ...
    function validerPaiement() {
        ...
        if ( livraisonValue == "Agences" ) {
            ...
            // Orange Money, Wave et/ou Visa QR
            // Call sendDatas() function with parameters
            sendDatas(datas, choixPaiementValue);
            return false ;
        }
    ...
    function sendDatas(donnees, choixPaiementValue) {
        ...
        var url = "";
        if (choixPaiementValue == "mtnmobilemoney") {
            url = "https://carte.abidjan.net/livre/mtn-money";
        } else if (choixPaiementValue == "orangemoney") {
            url = "https://carte.abidjan.net/livre/orange-money";
        } else if (choixPaiementValue == "VISA" || choixPaiementValue == "MASTERCARD") {
            url = "https://carte.abidjan.net/livre/visa";
        } else if (choixPaiementValue == "flooz") {
            url = "https://carte.abidjan.net/livre/moov-money";
        ...
        } else if ( choixPaiementValue == "wave"){
            url = "https://carte.abidjan.net/livre/wave";
        }
        ...
        $.ajax(settings).done(function(response) {
            ...
            } else if (response.ResponseCode == "WAVE-INITIATED") {

                // Wave
                getResponseWave(response) ;
    ...
    function getResponseWave(response) {

        // Sauvegarder le numéro de la commande
        window.localStorage.setItem("numCommande", response.num_commande) ;
        Swal.fire({
            title: 'Vous allez être redirigé sur la page de paiement',
            html: "Nous attendons votre paiement.",
            icon: 'info',
            showCancelButton: false,
            allowOutsideClick: false,
            allowEscapeKey: false,
