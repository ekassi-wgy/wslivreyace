                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6  col-md-6 col-sm-6">
                        ...
                        <ul class="breadcrumb-list text-center text-sm-end">
                            ...
                            <li class="breadcrumb-item active">Nos lecteurs</li>
                        </ul>
                        <!-- breadcrumb-list end -->
                    </div>
                </div>
...
<!--                " Le livre est disponible en précommande. La livraison est gratuite "-->
      ...
      <div class="card-image">
        <a href="https://media-files.abidjan.net/livre/img/phototeque/lecteurs/1.jpg" data-fancybox="gallery" data-caption="NOS LECTERUS">
          <img src="https://media-files.abidjan.net/livre/img/phototeque/lecteurs/1.jpg" alt="Image Gallery">
        </a>
      </div>
    </div>
			 ...
			 <div class="card col-md-3">
      <div class="card-image">
        <a href="https://media-files.abidjan.net/livre/img/phototeque/lecteurs/2.jpg" data-fancybox="gallery" data-caption="NOS LECTERUS">
          <img src="https://media-files.abidjan.net/livre/img/phototeque/lecteurs/2.jpg" alt="Image Gallery">
        </a>
      </div>
    </div>
