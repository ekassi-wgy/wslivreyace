                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6  col-md-6 col-sm-6">
                        ...
                        <ul class="breadcrumb-list text-center text-sm-end">
                            ...
                            <li class="breadcrumb-item active">Nos Cartoons</li>
                        </ul>
                        <!-- breadcrumb-list end -->
                    </div>
                </div>
...
<!--                " Le livre est disponible en précommande. La livraison est gratuite "-->
      ...
      <div class="card-image">
        <a href="https://media-files.abidjan.net/livre/img/phototeque/cartoons/1.jpg" data-fancybox="gallery" data-caption="Nos Cartoons">
          <img src="https://media-files.abidjan.net/livre/img/phototeque/cartoons/1.jpg" alt="Image Gallery">
        </a>
      </div>
    </div>
