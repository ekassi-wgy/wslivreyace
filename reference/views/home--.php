    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img class="img-modal" src="https://media-files.abidjan.net/livre/img/invitation-fnac.png"  data-at2x="https://media-files.abidjan.net/livre/img/invitation-fnac.png" alt="team member">
            </div>
        ...
        <div class="row displayBookSmallScreen" data-0="opacity: 1" data-800="opacity: 0">
            ...
            <div class="col-md-7">
                ...
                <header class="welcome-message">
                    ...
                    <p class="preface">* Pr̩face de Tidjane THIAM.</p>
                </header>
                <!--welcome message end-->
